export const bestThingsToDoData = [
    {
      id: 1,
      title: "Hassan II Mosque",
      desc: "Visit the stunning Hassan II Mosque, one of the largest mosques in the world, with its breathtaking architecture and a location overlooking the Atlantic Ocean.",
      image: "https://images.pexels.com/photos/6587429/pexels-photo-6587429.jpeg",
    },
    {
      id: 2,
      title: "Old Medina",
      desc: "Explore the historic Old Medina of Casablanca, a maze of narrow streets, vibrant markets, and traditional Moroccan architecture.",
      image: "https://as1.ftcdn.net/v2/jpg/01/84/39/10/1000_F_184391046_WZtyRaN6EZDTnoumFE1k5ngTuxg5rbpD.jpg",
    },
    {
      id: 3,
  ...
  export const fanzonesData = [
    {
      id: 1,
      title: "World Cup Central",
      desc: "Join the excitement at World Cup Central, the ultimate fanzone for watching the 2030 World Cup. Experience thrilling matches and a lively atmosphere.",
      image: "https://sportpro.ma/wp-content/uploads/2022/11/fifa-fan.png",
      address: "123 Fan Street, Casablanca",
    },
    {
      id: 2,
